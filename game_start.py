...
class Game:
    ...
    def start(self) -> None:
        ...
        logging.info(f"You will be asked a series of various {self.total_questions} questions.")
...
# Galiausiai sukuriam pagrindinę žaidimo paleidimo funkciją, sukurdami Žaidimo objektą su klausimais iš klausimų modulio.
#////English
